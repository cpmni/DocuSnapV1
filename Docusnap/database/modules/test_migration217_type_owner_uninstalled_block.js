...
check('TEST_SWITCH_KEYS is 18 keys (+ issuer_sibling_dominant_hold mig 218 + keyword_label_tail_bound mig 219 + suggested_teach_enabled mig 220)', TEST_SWITCH_KEYS.length === 18 && new Set(TEST_SWITCH_KEYS).size === 18);
