...
check('TEST_SWITCH_KEYS is 17 keys (+ issuer_sibling_dominant_hold mig 218 + keyword_label_tail_bound mig 219)', TEST_SWITCH_KEYS.length === 17 && new Set(TEST_SWITCH_KEYS).size === 17);
