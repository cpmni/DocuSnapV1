...
check("a fresh install ends with template_clip_commit_left_slack === 'true' (graduated by the mig-205 batch, 2026-09-22)", get('template_clip_commit_left_slack') === 'true');
