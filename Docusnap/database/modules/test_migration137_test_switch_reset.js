...
// Flip-census graduates (migs 172/173 @DEFAULT_FLIP, 2026-09-16): both ON by default + delisted (full contract in
// database/test_default_flip_156_159.js).
for (const k of ['name_role_nonname_flag', 'ref_confusable_flag']) {
