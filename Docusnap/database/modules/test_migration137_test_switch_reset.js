...
check('TEST_SWITCH_KEYS has 38 distinct keys', new Set(TEST_SWITCH_KEYS).size === 38 && TEST_SWITCH_KEYS.length === 38);  // 2026-09-09: confusable_soften added (147) then GRADUATED (148 @DEFAULT_FLIP); +confusable_prefix_autofile (149) +sweep_inview_recheck (150) → 34; 2026-09-10: +template_edge_clip_heal (151) +role_disagree_refuse_at100 (152) +template_taught_corrob_adopt (153) +trust_ref_role_shape (154) → 38
