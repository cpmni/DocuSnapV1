...
check('TEST_SWITCH_KEYS is 17 keys (13 after the 215 batch + this one + migs 217 + 218 + 219; suggested_teach_enabled mig 220 graduated via 221)', TEST_SWITCH_KEYS.length === 17 && new Set(TEST_SWITCH_KEYS).size === 17);
