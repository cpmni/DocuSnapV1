...
check('TEST_SWITCH_KEYS is 15 keys (13 after the 215 batch + this one + type_owner_uninstalled_block mig 217)', TEST_SWITCH_KEYS.length === 15 && new Set(TEST_SWITCH_KEYS).size === 15);
