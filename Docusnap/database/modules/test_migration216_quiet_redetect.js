...
check('TEST_SWITCH_KEYS is 18 keys (13 after the 215 batch + this one + migs 217 + 218 + 219 + suggested_teach_enabled mig 220)', TEST_SWITCH_KEYS.length === 18 && new Set(TEST_SWITCH_KEYS).size === 18);
