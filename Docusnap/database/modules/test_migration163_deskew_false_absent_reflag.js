...
check('TEST_SWITCH_KEYS is now 50 (mig 163 + departments_enabled + mig 166 date-yield + mig 167 date_forms_wide; direct_intake_enabled graduated to default-ON via mig 171 + delisted 2026-09-15)', TEST_SWITCH_KEYS.length === 50);
