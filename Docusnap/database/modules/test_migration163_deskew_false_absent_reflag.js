...
check('TEST_SWITCH_KEYS is now 45 (+anchor_code_left_grow mig 192 2026-09-20 DARK; taught_ref_disagree_suppress 186→191 GRADUATED via the live VM verify 2026-09-20 + delisted; note_topic_dedup 158→189 + reread_hold_corrob_release 130→190 GRADUATED via flip census batch 2 2026-09-19 + delisted; (trust_ref_role_shape 154→187 + template_drift_override_guard 157→188 GRADUATED via the flip census 2026-09-19 + delisted; +taught_ref_disagree_suppress mig 186 2026-09-19; +ref_badge_verify_state mig 185 2026-09-18; mig 163 + departments_enabled + mig 166 date-yield + mig 167 date_forms_wide; direct_intake_enabled graduated via mig 171 2026-09-15; name_role_nonname_flag + ref_confusable_flag + template_pad_date_adopt + watch_separate_enabled graduated via migs 172-175 2026-09-16, all delisted; +segment_pair_hold (180) 2026-09-17; segment_continuation_veto (177→181) + segment_title_slug (178→182) + segment_known_supplier_change (179→183) GRADUATED 2026-09-17 + delisted)', TEST_SWITCH_KEYS.length === 45);
