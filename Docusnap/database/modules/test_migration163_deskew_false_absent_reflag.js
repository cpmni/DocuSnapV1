...
check('TEST_SWITCH_KEYS is now 46 (mig 163 + departments_enabled + mig 166 date-yield + mig 167 date_forms_wide; direct_intake_enabled graduated via mig 171 2026-09-15; name_role_nonname_flag + ref_confusable_flag + template_pad_date_adopt + watch_separate_enabled graduated via migs 172-175 2026-09-16, all delisted)', TEST_SWITCH_KEYS.length === 46);
