...
console.log('1. a fresh install');
{
  ...
  check('TEST_SWITCH_KEYS is 17 (13 after this batch + migs 216/217/218/219; suggested_teach_enabled mig 220 GRADUATED via @DEFAULT_FLIP 221, 2026-09-26)', TEST_SWITCH_KEYS.length === 17);
