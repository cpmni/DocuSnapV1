...
console.log('1. a fresh install');
{
  ...
  check('TEST_SWITCH_KEYS is 16 (13 after this batch + quiet_redetect_on_type_change mig 216 + type_owner_uninstalled_block mig 217 + issuer_sibling_dominant_hold mig 218, 2026-09-25)', TEST_SWITCH_KEYS.length === 16);
