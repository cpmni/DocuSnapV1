'use strict';
/*
 * test_default_flip_189_190.js — migrations 189/190: note_topic_dedup (158) + reread_hold_corrob_release (130)
 * GRADUATE to customer defaults (2026-09-19, owner go after the flip census batch 2).
 *
 *   Both byte-identical / M=0 on the 400-doc corpus (TESTING/_measure/flip_census_20260919/RESULT.md) — low-risk
 *   note/hold handling with no value change; the synthetic corpus cannot exercise them, so this is a SAFETY flip
 *   (owner call). mig 189/190 UPSERT each to 'true'. Same flip-home contract as test_default_flip_187_188.js.
 *
 * Run: ELECTRON_RUN_AS_NODE=1 ./node_modules/electron/dist/electron.exe database/test_default_flip_189_190.js
 */
...
const FLIPS = [
  { key: 'note_topic_dedup',           seed: 158, flip: 189 },
  { key: 'reread_hold_corrob_release', seed: 130, flip: 190 },
];
