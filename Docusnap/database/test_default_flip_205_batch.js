...
const HELD = [
  ...
  //  suggested_teach_enabled 220 GRADUATED via @DEFAULT_FLIP 221, 2026-09-26 — see test_default_flip_221.js.)
];
...
check('HELD is 17 distinct keys', new Set(HELD).size === 17);   // 18 → 17: suggested_teach_enabled GRADUATED via @DEFAULT_FLIP 221 (2026-09-26)   // 17 → 18 was: suggested_teach_enabled (mig 220)   // 16 → 17: keyword_label_tail_bound (mig 219)   // 15 → 16: issuer_sibling_dominant_hold (mig 218)   // 14 → 15: type_owner_uninstalled_block (mig 217)
