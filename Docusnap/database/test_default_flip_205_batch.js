...
const HELD = [
  ...
  'glyph_slice_integrity', 'name_value_label_flag',         // mig 212, 2026-09-23 — second-reader crop snapped to the page word boxes (pixels only)
];
...
check('HELD is 17 distinct keys', new Set(HELD).size === 17);
