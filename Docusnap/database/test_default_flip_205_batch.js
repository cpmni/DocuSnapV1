...
const HELD = [
  ...
  'glyph_slice_integrity',         // mig 212, 2026-09-23 — second-reader crop snapped to the page word boxes (pixels only)
];
...
check('HELD is 16 distinct keys', new Set(HELD).size === 16);
