...
**Regressions (a confirmed value the pipeline no longer reproduces): 11** — of which 9 SILENT (wrong + no review flag).
...
- #1032 sales_order ref: want 'SO-73799' got 'PO-81784' [SILENT]
...
**Auto-file soundness (#6): 570/605 reprocessed docs would auto-file; 7 would auto-file a WRONG value (must be 0).**
