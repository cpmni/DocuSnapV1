// setup.js — migrate the 700-corpus copy to HEAD (mig 198) + emit the test-doc id list.
// Test docs = learning_excluded, confirmed (build_warm_db.js convention).
//   ELECTRON_RUN_AS_NODE=1 node_modules/electron/dist/electron.exe TESTING/_measure/flip_census_20260921/setup.js
const fs = require('fs');
const path = require('path');
const ROOT = 'C:/GIT Projects/Docusnap';
const Database = require(path.join(ROOT, 'node_modules/better-sqlite3'));
const { runMigrations } = require(path.join(ROOT, 'database/index'));
const DIR = path.join(ROOT, 'TESTING/_measure/flip_census_20260921');
