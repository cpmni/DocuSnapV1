# Customer-corpus score — TAG=eff_serial200 (SET=both, SAMPLE=288, SEED=7)

Processed 288/288 sampled docs (cold install — no learning/templates).

Operating point: DPI 200 · OMP 1 · pools false · 111 app env var(s) from the fresh-install DB (mig 139) · overrides {"OMP_THREAD_LIMIT":"1"}
