...
const WORKFLOW_FEATURE_ENABLED = true;   // FLIPPED ON 2026-08-02 (owner) — mailbox/approval workflow live for the dev trial; flip back to false to re-hide pre-release
