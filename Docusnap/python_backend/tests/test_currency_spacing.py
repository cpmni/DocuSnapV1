...
# decimal split by OCR spacing (space before/after the point, or point dropped)
check("space before the point rejoined", NS("$5,767 .71") == "$5,767.71")
check("space after the point rejoined", NS("$5,767. 71") == "$5,767.71")
check("space both sides of the point rejoined", NS("$5,767 . 71") == "$5,767.71")
check("dropped point (trailing 2 digits) rejoined", NS("$5,767 71") == "$5,767.71")
check("thousands + decimal together", NS("$1 234 567 89") == "$1,234,567.89")
check("integer-only value with no cents untouched", NS("$100") == "$100")
